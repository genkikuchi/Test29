...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "test29" because\n';
  ...
  $wnd.__gwt_activeModules['test29'] = {
    'moduleName' : 'test29',
    'bindings' : function() {
      return {};
    }
 ...
 * "/test29.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['test29'].superdevmode = true;

  var expectedSuffix = '/test29.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + test29 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:test29';
  var devModeSessionKey = '__gwtDevModeSession:test29';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/test29/test29.nocache.js';
  ...
  $wnd.__gwt_activeModules['test29'].canRedirect = true;
  $wnd.__gwt_activeModules['test29'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/test29?user.agent=' + ua + '&_callback=' + callback;
